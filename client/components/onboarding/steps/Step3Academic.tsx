            ...
            <div className="flex items-center justify-between px-4 py-3"
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  onMouseEnter={e => {
                    if (!showYearDropdown) e.currentTarget.style.background = 'rgba(255,255,255,0.08)'
                  }}
                  onMouseLeave={e => {
                    if (!showYearDropdown) e.currentTarget.style.background = 'transparent'
                  }}
                >
                  {viewYear}
                  ...
                  {YEARS.map(year => {
                    ...
                    return (
                      <button
                        ...
                        onMouseEnter={e => {
                          if (!isActive) e.currentTarget.style.background = 'rgba(99,102,241,0.12)'
                        }}
                        onMouseLeave={e => {
...
export default function Step3Academic({ onNext, onBack, data, dark, textPrimary, textMuted, border }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-2" style={{ color: textPrimary }}>Academic background</h1>
        <p className="text-base" style={{ color: textMuted }}>Add your education history. You can add multiple degrees.</p>
      </motion.div>
      ...
      <div className="space-y-4 mb-6">
        {items.map((edu, i) => (
          <motion.div
            ...
            style={{ border: `1px solid ${openId === edu.id ? '#6366f1' : border}` }}
          >
            <div
            ...
            >
              <div>
                ...
                {edu.institution && (
                  <div className="text-xs mt-0.5" style={{ color: textMuted }}>{edu.institution}</div>
                )}
              </div>
              <div className="flex items-center gap-2">
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                  style={{ color: textMuted, transform: openId === edu.id ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.2s' }}>
                  <polyline points="6 9 12 15 18 9"/>
                </svg>
              </div>
            </div>
                ...
                >
                  <div className="grid grid-cols-2 gap-4 p-5" style={{ background: dark ? '#070711' : '#ffffff' }}>
                    ...
                    <div className="col-span-2">
                      <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: textMuted }}>Degree *</label>
                    ...
                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: textMuted }}>Institution *</label>
                    ...
                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: textMuted }}>Field of Study</label>
                    ...
                    <div className="col-span-2 flex items-center gap-3">
                      <input type="checkbox" id={`current-${edu.id}`}
                        checked={edu.current}
                        onChange={e => update(edu.id, 'current', e.target.checked)}
                        className="w-4 h-4 cursor-pointer" style={{ accentColor: '#6366f1' }}
                      />
                      <label htmlFor={`current-${edu.id}`} className="text-sm cursor-pointer" style={{ color: textMuted }}>
                        I am currently studying here
                      </label>
                    </div>

                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: textMuted }}>GPA (optional)</label>
                    ...
                    <div className="col-span-2">
                      <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: textMuted }}>Description (optional)</label>
      ...
      <div className="flex gap-3">
        ...
        <button onClick={() => onNext({ education: items })}
